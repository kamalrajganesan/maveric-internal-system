                ...
                <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div>
                                <p class="statistics-title">New Customers</p>
                                <h3 class="rate-percentage">68.8</h3>
                                <!-- <p class="text-danger d-flex"><i class="mdi mdi-menu-down"></i><span>68.8</span></p> -->
                            </div>
                            <div class="d-none d-md-block">
                                <p class="statistics-title">Avg. Transactions/Day </p>
                            ...
                            <div class="d-none d-md-block">
                                <p class="statistics-title">Leads Conversion Rate</p>
                            ...
                            <div class="col-md-6 col-lg-12 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div>
                                            <p class="text-small mb-2">Total Customers</p>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div>
                                            <p class="text-small mb-2">Leads/day</p>
                        ...
                        <div class="col-lg-8 d-flex flex-column">
                            ...
                            <div class="col-12 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                            <h4 class="card-title card-title-dash">Transactions Overview</h4>
                                            <p class="card-subtitle card-subtitle-dash">Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
                                        </div>
                                    </div>
                                    <div class="d-sm-flex align-items-center mt-1 justify-content-between">
                                    <div class="d-sm-flex align-items-center mt-4 justify-content-between">
                                        <h2 class="me-2 fw-bold">4,253</h2>
                            ...
                            <div class="col-12 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <p class="card-subtitle card-subtitle-dash">You have 50+ new Transactions</p>
                                    </div>
                                    <div>
                            ...
                            <div class="col-md-6 col-lg-6 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <li>
                                        ...
                                        <div><span class="text-light-green">Agent 2</span> recorded a trasaction</div>
                                        <p>Just now</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex justify-content-between">
                                        <div><span class="text-light-green">Agent 4</span> recorded a trasaction</div>
                                        <p>1h</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex justify-content-between">
                                        <div><span class="text-light-green">Agent 1</span> recorded a trasaction</div>
                                        <p>1h</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex justify-content-between">
                                        <div><span class="text-light-green">Agent 5</span> recorded a trasaction</div>
                                        <p>1h</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="d-flex justify-content-between">
                                        <div><span class="text-light-green">Agent 3</span> recorded a trasaction</div>
                                        <p>1h</p>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <ul class="todo-list todo-list-rounded">
                                            ...
                                            <div class="form-check w-100">
                                                ...
                                                <div class="ps-4 text-small me-3">25 December, 2024</div>
                                            ...
                                            <div class="form-check w-100">
                                                ...
                                                <div class="d-flex mt-2">
                                                <div class="ps-4 text-small me-3">23 December, 2024</div>
                                            ...
                                            <div class="form-check w-100">
                                                ...
                                                <div class="d-flex mt-2">
                                                <div class="ps-4 text-small me-3">23 Decemberm 2024</div>
                                                <div class="badge badge-opacity-success me-3">Done</div>
                                                </div>
                                            </div>
                                            </li>
                                            ...
                                            <div class="form-check w-100">
                                                ...
                                                <div class="d-flex mt-2">
                                                <div class="ps-4 text-small me-3">22 December, 2024</div>
                            ...
                            <div class="col-12 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div>
                                            <h4 class="card-title card-title-dash">Overall Leads Report</h4>
                                        </div>
                                        </div>
                                        <div class="mt-3">
                            ...
                            <div class="col-12 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div>
                                            <h4 class="card-title card-title-dash">Top Performers of the Month</h4>
                                        </div>
                                        </div>
                                        <div class="mt-3">
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                            ...
                                            <div class="wrapper ms-3">
                                                <p class="ms-1 mb-1 fw-bold">Agent 1</p>
                                        ...
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                            ...
                                            <div class="wrapper ms-3">
                                                <p class="ms-1 mb-1 fw-bold">Agent 3</p>
                                                <small class="text-muted mb-0">162543</small>
                                            </div>
                                            </div>
                                        </div>
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                            ...
                                            <div class="wrapper ms-3">
                                                <p class="ms-1 mb-1 fw-bold">Agent 5</p>
                                                <small class="text-muted mb-0">162543</small>
                                            </div>
                                            </div>
                                        </div>
                                        <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                            ...
                                            <div class="wrapper ms-3">
                                                <p class="ms-1 mb-1 fw-bold">Agent 4</p>
                                                <small class="text-muted mb-0">162543</small>
                                            </div>
                                            </div>
                                        </div>
                                        <div class="wrapper d-flex align-items-center justify-content-between pt-2">
                                            ...
                                            <div class="wrapper ms-3">
                                                <p class="ms-1 mb-1 fw-bold">Agent 6</p>
                                                <small class="text-muted mb-0">162543</small>
                                            </div>
                                            </div>
                                        </div>
...
<script src="assets/default-js/dashboard.js"></script>
