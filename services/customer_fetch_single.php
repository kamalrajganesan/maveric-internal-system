...
if(isset($_POST['customerId'])) {
    ...
    $db = new sqlHelper();
    $customerFetchSingleSQL = "SELECT c.*, (SELECT agent_nm FROM agent a WHERE a.id = c.updated_by) AS updated_by FROM cust_mstr c WHERE is_deleted = 0 and customer_uniq_code = ?";
