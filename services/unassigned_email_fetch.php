...
// Modified base query to only fetch unassigned leads
$FetchAllSQL = "SELECT * FROM lead_email_tracker WHERE is_deleted = 0 AND (assignee IS NULL OR assignee = 0 OR assignee = '')";
...
// Remove the role-based assignment filtering since we only want unassigned leads
// The original role-based logic would override our unassigned filter
