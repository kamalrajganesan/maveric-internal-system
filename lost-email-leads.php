...
<div class="btn-wrapper">
    <button class="btn btn-otline-dark align-items-center" id="resetLeadsBtn">
...
<div class="modal fade" id="resetConfirmModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Are you sure you want to reset <strong>all Lost Email leads</strong> 
      </div>
      <div class="modal-footer">
    ...
    <script src="assets/custom-js/lostemailleads.js"></script>
